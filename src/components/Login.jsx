      ...
      <div className="bg-white/80 backdrop-blur-2xl shadow-[0_20px_50px_rgba(184,146,33,0.1)] rounded-[2.5rem] p-12 w-full max-w-md border border-white/50 ring-1 ring-yellow-200/50">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight">
            ...
            <span className="text-slate-800 underline decoration-yellow-400 decoration-4 underline-offset-4">
              Man
            </span>
          </h1>
        ...
        <div className="space-y-5">
          <div>
            <label className="block text-[11px] font-bold text-slate-400 uppercase tracking-wider ml-1 mb-2">
              Email Address
            </label>
            <input
              type="email"
          ...
          <div>
            <div className="flex justify-between ml-1 mb-2">
              ...
              <button className="text-[11px] font-bold text-yellow-600 hover:text-yellow-700">
                Forgot?
              </button>
            </div>
            <input
          ...
          <p className="text-center text-slate-400 text-sm mt-6">
            New here?{" "}
            <button className="text-yellow-600 font-bold hover:underline">
              Create Account
            </button>
          </p>
        </div>
